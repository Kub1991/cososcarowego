/*
  ...
  1. New Table
    - `user_oscar_progress` - Tracks user progress in watching Oscar movies
    - Automatically calculates progress by decade and Oscar year
    - Updates in real-time when movies are marked as watched

  2. Trigger System
    - Automatic calculation when user marks movie as watched
    - Updates progress for both decade and specific Oscar year
    - Maintains accurate counts and percentages
...
BEGIN
  ...
  RAISE NOTICE '======================================================';
  RAISE NOTICE 'user_oscar_progress table created: %', progress_table_exists;
  RAISE NOTICE 'update_user_oscar_progress function created: %', function_exists;
  RAISE NOTICE 'on_movie_watched_update_progress trigger created: %', trigger_exists;
  RAISE NOTICE '';
  ...
  RAISE NOTICE '   - Responsive progress visualization in "Moja podróż"';
  RAISE NOTICE '';
